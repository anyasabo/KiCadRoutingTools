...
def get_dialog_settings(dialog):
    ...
    settings = {
        ...
        "net_panel_hide_diff": dialog.net_panel.hide_diff_check.GetValue()
        if dialog.net_panel.hide_diff_check
        else False,
        ...
        "swappable_hide": dialog.swappable_net_panel.hide_check.GetValue()
        if dialog.swappable_net_panel.hide_check
        else False,
        "diff_panel_hide": dialog.differential_tab.pair_panel.hide_check.GetValue()
        if dialog.differential_tab.pair_panel.hide_check
        else False,
        "fanout_hide": dialog.fanout_tab.net_panel.hide_check.GetValue()
        if dialog.fanout_tab.net_panel.hide_check
        else False,
        # Filters
        ...
        # Component dropdowns
        "net_panel_component": dialog.net_panel.component_dropdown.GetSelection()
        if dialog.net_panel.component_dropdown
        else 0,
        "swappable_component": dialog.swappable_net_panel.component_dropdown.GetSelection()
        if dialog.swappable_net_panel.component_dropdown
        else 0,
        "diff_panel_component": dialog.differential_tab.pair_panel.component_dropdown.GetSelection()
        if dialog.differential_tab.pair_panel.component_dropdown
        else 0,
        "fanout_component": dialog.fanout_tab.net_panel.component_dropdown.GetSelection()
        if dialog.fanout_tab.net_panel.component_dropdown
        else 0,
        ...
        "planes_hide": dialog.planes_tab.net_panel.hide_check.GetValue()
        if dialog.planes_tab.net_panel.hide_check
        else False,
        "planes_filter": dialog.planes_tab.net_panel.filter_ctrl.GetValue(),
        "planes_component": dialog.planes_tab.net_panel.component_dropdown.GetSelection()
        if dialog.planes_tab.net_panel.component_dropdown
        else 0,
        # Create mode options
